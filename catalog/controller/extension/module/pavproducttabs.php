...
class ControllerExtensionModulePavproducttabs extends Controller {
	...
	public function index($setting) {
		...
		$this->load->language('extension/module/pavproducttabs');
		...
		return $this->load->view('extension/module/pavproducttabs', $this->data);
	}
