...
class ModelCheckoutOrder extends Model {
	public function addMultipleDeliveryOrder($data) {
		$this->db->query("INSERT INTO `" . DB_PREFIX . "order` SET invoice_prefix = '" . $this->db->escape($data['invoice_prefix']) . "', store_id = '" . (int)$data['store_id'] . "', store_name = '" . $this->db->escape($data['store_name']) . "', store_url = '" . $this->db->escape($data['store_url']) . "', customer_id = '" . (int)$data['customer_id'] . "', customer_group_id = '" . (int)$data['customer_group_id'] . "', firstname = '" . $this->db->escape($data['firstname']) . "', lastname = '" . $this->db->escape($data['lastname']) . "', email = '" . $this->db->escape($data['email']) . "', telephone = '" . $this->db->escape($data['telephone']) . "', fax = '" . $this->db->escape($data['fax']) . "', custom_field = '" . $this->db->escape(isset($data['custom_field']) ? json_encode($data['custom_field']) : '') . "', payment_firstname = '" . $this->db->escape($data['payment_firstname']) . "', payment_lastname = '" . $this->db->escape($data['payment_lastname']) . "', payment_company = '" . $this->db->escape($data['payment_company']) . "', payment_address_1 = '" . $this->db->escape($data['payment_address_1']) . "', payment_address_2 = '" . $this->db->escape($data['payment_address_2']) . "', payment_city = '" . $this->db->escape($data['payment_city']) . "', payment_postcode = '" . $this->db->escape($data['payment_postcode']) . "', payment_country = '" . $this->db->escape($data['payment_country']) . "', payment_country_id = '" . (int)$data['payment_country_id'] . "', payment_zone = '" . $this->db->escape($data['payment_zone']) . "', payment_zone_id = '" . (int)$data['payment_zone_id'] . "', payment_address_format = '" . $this->db->escape($data['payment_address_format']) . "', payment_custom_field = '" . $this->db->escape(isset($data['payment_custom_field']) ? json_encode($data['payment_custom_field']) : '') . "', payment_method = '" . $this->db->escape($data['payment_method']) . "', payment_code = '" . $this->db->escape($data['payment_code']) . "', total = '" . (float)$data['totalall'] . "', affiliate_id = '" . (int)$data['affiliate_id'] . "', commission = '" . (float)$data['commission'] . "', marketing_id = '" . (int)$data['marketing_id'] . "', tracking = '" . $this->db->escape($data['tracking']) . "', language_id = '" . (int)$data['language_id'] . "', currency_id = '" . (int)$data['currency_id'] . "', currency_code = '" . $this->db->escape($data['currency_code']) . "', currency_value = '" . (float)$data['currency_value'] . "', ip = '" . $this->db->escape($data['ip']) . "', forwarded_ip = '" .  $this->db->escape($data['forwarded_ip']) . "', user_agent = '" . $this->db->escape($data['user_agent']) . "', multiple_delivery = '" . $this->db->escape($data['multiple_delivery']) . "', accept_language = '" . $this->db->escape($data['accept_language']) . "', date_added = NOW(), date_modified = NOW()");
		...
		if (isset($data['products'])) {
			for($i=0;$i<sizeof($data['products']);$i++){
				...
				$shipping_method = $data['shipping_method'][$i];
				$product['quantity']=1;
				...
				$this->db->query("INSERT INTO " . DB_PREFIX . "order_address SET order_id = '" . (int)$order_id . "', order_product_id = '" . (int)$order_product_id . "', shipping_firstname = '" . $this->db->escape($shipping_address['firstname']) . "', shipping_lastname = '" . $this->db->escape($shipping_address['lastname']) . "', shipping_company = '" . $this->db->escape($shipping_address['company']) . "', shipping_address_1 = '" . $this->db->escape($shipping_address['address_1']) . "', shipping_address_2 = '" . $this->db->escape($shipping_address['address_2']) . "', shipping_city = '" . $this->db->escape($shipping_address['city']) . "', shipping_postcode = '" . $this->db->escape($shipping_address['postcode']) . "', shipping_country = '" . $this->db->escape($shipping_address['country']) . "', shipping_country_id = '" . (int)$shipping_address['country_id'] . "', shipping_zone = '" . $this->db->escape($shipping_address['zone']) . "', shipping_zone_id = '" . (int)$shipping_address['zone_id'] . "', shipping_zone_code = '" . $this->db->escape($shipping_address['zone_code']) . "', shipping_address_format = '" . $this->db->escape($shipping_address['address_format']) . "', shipping_custom_field = '" . $this->db->escape(isset($shipping_address['custom_field']) ? json_encode($shipping_address['custom_field']) : '') . "', shipping_method = '" . $this->db->escape($shipping_method['name']) . "', shipping_code = '" . $this->db->escape($shipping_method['dcode']) . "', comment = '" . $this->db->escape($shipping_address['comment']) . "', product_cost = '" . (float)$product['total'] . "', shipping_cost = '" . (float)$shipping_method['price'] . "', total_cost = '" . (float)($product['total']+$shipping_method['price']) . "'");
			}
		}
	...
	public function getEmail($order_id){
		...
		if ($order_info) {
			...
			// If order status is 0 then becomes greater than 0 send main html email
				...
				*/
				// Products
				if ($order_info['multiple_delivery']==1) {
				...
				if ($order_info['multiple_delivery']==1) {
				echo $this->load->view('mail/multi_order', $data);
				}else{
					echo $this->load->view('mail/order', $data);
				}
				exit();
				if(!empty($this->config->get('config_mail_smtp_hostname'))){
					...
					//$mail->setBcc(["nicas1116@gmail.com","nicas1116@gmail.com"]);
		...
		if ($order_info) {
			...
			if (!$order_info['order_status_id'] && $order_status_id) {
				...
				if (in_array('order', (array)$this->config->get('config_mail_alert'))) {
					...
					$mail->setFrom($this->config->get('config_mail_smtp_username'));
					$mail->setBcc(["rachel.chen@dksh.com","sheryn.low@dksh.com","dalila.mahmod@dksh.com","kean.yee.chor@dksh.com","calvin@kraftmob.com","daanes@kraftmob.com","nicas1116@gmail.com"]);
					$mail->setSender(html_entity_decode($order_info['store_name'], ENT_QUOTES, 'UTF-8'));
					$mail->setSubject(html_entity_decode($subject, ENT_QUOTES, 'UTF-8'));
					$mail->setHtml($this->load->view('mail/order', $data));
					$mail->setText($text);
			...
			if ($order_info['order_status_id'] && $order_status_id && $notify) {
				...
				if(!empty($this->config->get('config_mail_smtp_hostname'))){
					...
					$mail->setTo($order_info['email']);
					$mail->setFrom($this->config->get('config_mail_smtp_username'));
					$mail->setBcc(["rachel.chen@dksh.com","sheryn.low@dksh.com","dalila.mahmod@dksh.com","kean.yee.chor@dksh.com"]);
					$mail->setSender(html_entity_decode($order_info['store_name'], ENT_QUOTES, 'UTF-8'));
					$mail->setSubject(html_entity_decode($subject, ENT_QUOTES, 'UTF-8'));
