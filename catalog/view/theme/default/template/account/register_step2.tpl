...
if(isset($facebookdata)){
  ...
  $register_email = $email = $facebookemail = $facebookdata["email"];
  $register_confirm  = $register_password = $confirm = $password = $facebookpassword = substr($facebookid,0,15);
  //echo $password;
    ...
    <div id="content" class="<?php echo $class; ?> registerpage"><?php echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset id="personal">
          <input type="hidden" name="email" value="<?php echo $register_email; ?>">
          <input type="hidden" name="password" value="<?php echo $register_password; ?>">
          <input type="hidden" name="confirm" value="<?php echo $register_confirm; ?>">
        ...
        <?php echo $captcha; ?>
        <?php if ($text_agree) { ?>
        <div class="buttons" id="buttonsall">
          <div class="">
