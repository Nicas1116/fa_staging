      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
          ...
          <div class="form-group" style="display: none;">
            ...
            <div class="col-sm-12">
              <input type="text" name="fax" value="0" placeholder="<?php echo $entry_fax; ?>" id="input-fax" class="form-control" />
            </div>
          </div>
          <fieldset>
         <h4>If you do not wish to change your password, leave both fields blank</h4>
          <div class="form-group required">
