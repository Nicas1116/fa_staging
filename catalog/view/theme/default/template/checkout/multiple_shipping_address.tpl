...
<form class="form-horizontal">
  ...
  <?php for ($i=0 ;$i<$recipentno;$i++) { ?>
  <div class="receiptbox" id="recipent<?php echo ($i+1); ?>">
    <p>Recipient #<?php echo ($i+1); ?></p>
...
function postcodechange(receiptno) {
  creceiptno = receiptno;
    $.ajax({
        ...
        type: 'post',
        data: $('#collapse-shipping-address #recipent'+receiptno+' input[type=\'hidden\'], #collapse-shipping-address #recipent'+receiptno+' input[type=\'text\'], #collapse-shipping-address #recipent'+receiptno+' input[type=\'date\'], #collapse-shipping-address #recipent'+receiptno+' input[type=\'datetime-local\'], #collapse-shipping-address #recipent'+receiptno+' input[type=\'time\'], #collapse-shipping-address #recipent'+receiptno+' input[type=\'password\'], #collapse-shipping-address #recipent'+receiptno+' input[type=\'checkbox\']:checked, #collapse-shipping-address #recipent'+receiptno+' input[type=\'radio\']:checked, #collapse-shipping-address #recipent'+receiptno+' textarea, #collapse-shipping-address #recipent'+receiptno+' select'),
        dataType: 'json',
        beforeSend: function() {
        },
        complete: function() {
