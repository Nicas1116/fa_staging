        ...
        <table class="table table-bordered">
          ...
          <tbody>
            <?php foreach ($order_addresses as $order_address) { 
              $product = $order_address["product"];
              ?>
            <tr>
              <td class="text-left">
                <style type="text/css">
                  .order_address h3{font-size: 14px;font-weight: 600;}
                  .order_address{margin-bottom: 20px;}
                  .order_address p{margin-bottom: 0px;}
                </style>
                <div class="order_address"><h3>Shipping Address</h3><?php echo $order_address["shipping_address"]; ?></div>
