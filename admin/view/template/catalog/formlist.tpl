  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <a href="<?php echo $createform; ?>" data-toggle="tooltip" title="Create New Form" class="btn btn-primary"><i class="fa fa-plus"></i> Create New Form</a>
      </div>
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
			  ...
			  <tbody>
				...
				<tr>
					<td>
						<?php if (in_array($module['module_id'], $selected)) { ?>
